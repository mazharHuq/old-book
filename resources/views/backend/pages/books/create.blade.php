            ...
            <div class="intro-y box p-5">
                ...
                <div class="mt-3">
                    ...
                    <div class="relative mt-2">
                        <input type="number" class="input pr-12 w-full border col-span-4" placeholder="How many days used?"  name="used">
                ...
                <div class="mt-3">
                    ...
                    <div class="relative mt-2">
                        <input type="number" class="input pr-12 w-full border col-span-4" placeholder="New price"  name="buy_price">
                ...
                <div class="mt-3">
                    ...
                    <div class="relative mt-2">
                        <input type="number" class="input pr-12 w-full border col-span-4" placeholder="Selling  price"  name="sell_price">
                        <div class="absolute top-0 right-0 rounded-r w-10 h-full flex items-center justify-center bg-gray-100 border text-gray-600">BDT</div>
                    </div>
                </div>
