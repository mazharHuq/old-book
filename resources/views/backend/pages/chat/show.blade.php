                    ...
                    <div class="tab-content__pane active" id="chats">
                        ...
                        <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
                            ...
                            @foreach($users as $user)
                                <a href="{{route('dashboard.chat.show',$user->id)}}" class="font-medium">
                    ...
                    <div class=" h-full flex flex-col">
                        <div class="flex flex-col sm:flex-row border-b border-gray-200 px-5 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 mr-auto">
                                    <div class="font-medium text-base">{{\App\Models\Admin::find($receiver)->name}}</div>
                        ...
                        <div class="overflow-y-scroll px-5 pt-5 flex-1">
                            @foreach($active_chats as $chat)
                               @if($chat->user_id==$sender and  $chat->user_id2==$receiver or $chat->user_id2==$sender and $chat->user_id2==$receiver)
                        ...
                        <form action="{{route('dashboard.chat.store')}}" method="post" >
                            ...
                            <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200">
                                <input type="hidden" name="user_id2" value="{{$receiver}}" >
