...
<body class="bg-light">
<div class="container shadow p-2"  style="padding: 5px">
    <div class="py-5 text-center m-3" style="color: #ff6f00;border-bottom: 2px solid black">
        <h2>Buy Our Premium Membership</h2>
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="customer_email" class="form-control" id="email"
                           placeholder="you@example.com" value="{{auth('web')->user()->email
}}" required>
                    <div class="invalid-feedback">
