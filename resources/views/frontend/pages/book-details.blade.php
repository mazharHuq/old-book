            ...
            <div class="col-10 book-details p-4 shadow">
                ...
                <div class="book-middle row p-4">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        ...
                        <div class="b-3 p-2" >
                            <i class="fas fa-comments-dollar fa-2x color-primary" ></i> <span style="font-size: large;vertical-align: top;"><b>Chat</b></span>

                        </div>
                        <div class="p-4" style=" border:1px solid rgb(42, 190, 160) ;border-radius: 10px;">
