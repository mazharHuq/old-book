            ...
            <div class="col-span-12 lg:col-span-4 xxl:col-span-3">
                ...
                <div class="tab-content">
                    <div class="tab-content__pane active" id="chats">
                        ...
                        $current_chat=\App\Models\Chat::reciever($chat);
                        @endphp
                            @foreach($chatRoom as $user)
                                ...
                                <div class="intro-x cursor-pointer box relative
                                 @if($current_chat->id==$reciever->id)
                                  ...
                                  flex items-center p-5 ">
                                    ...
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                                            <a href="{{route('user.chat.show',$reciever->id)}}"
                ...
                <div class="chat__box box">
                    ...
                    <div class=" h-full flex flex-col">
                        <div class="flex flex-col sm:flex-row border-b border-gray-200 px-5 py-4">
                            <div class="flex items-center">
                                <div class="w-10 h-10 sm:w-12 sm:h-12 flex-none image-fit relative">
                                        ...
                                        <img alt="" class="rounded-full" src="{{asset('image/user2.png')}}">

                                </div>
                                <div class="ml-3 mr-auto">
                                    <div class="font-medium text-base">{{$reciever->name}}</div>
                        ...
                        <div class="overflow-y-scroll px-5 pt-5 flex-1">
                            @php
                            $receiver=\App\Models\Chat::reciever($chat);


                            @endphp

                            @foreach($chat->message as $chat)
                               @if($chat->sender_id==auth('web')->user()->id)
                                    <div class="chat__box__text-box flex items-end float-right mb-4">

                                        <div class="bg-gray-200 text-black px-4 py-3 text-white rounded-l-md rounded-t-md">
                                           {{$chat->message}}
                                            <div class="mt-1 text-xs text-green-700">{{\Carbon\Carbon::createFromTimeStamp(strtotime($chat->created_at))->diffForHumans()}}</div>
                                        </div>
                                ...
                                @else
                                    <div class="chat__box__text-box flex items-end float-left mb-4">
                                        <div class="w-10 h-10 hidden sm:block flex-none image-fit relative mr-5">
                                            <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{asset('image/user2.png')}}">
                                        </div>
                                        <div class="bg-gray-200 px-4 py-3 text-black rounded-r-md rounded-t-md">
                                            {{$chat->message}}
                                            <div class="mt-1 text-xs text-gray-600">{{\Carbon\Carbon::createFromTimeStamp(strtotime($chat->created_at))->diffForHumans()}}</div>
                                        </div>
