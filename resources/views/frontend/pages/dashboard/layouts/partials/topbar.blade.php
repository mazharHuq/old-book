            ...
            <div class="dropdown-box__content box bg-theme-38 text-white">
                ...
                <div class="p-2 border-t border-theme-40">
                    <form method="POST" action="{{ route('dashboard.logout.submit') }}">
                        @csrf
                        <a href="{{ route('user.logout.submit') }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md" onclick="event.preventDefault();
