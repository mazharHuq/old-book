...
@section('main-section')
    ...
    <div class="container pb-16">
        <div class=" bg-gray-200 flex justify-center item-center my-2">
            <h1 class="text-4xl font-semibold uppercase my-4">Book Posted By {{$seller->name}}</h1>
        </div>
        ...
        @foreach($books as $book)
            <!--single Product-->
                <div class="bg-white overflow-hidden rounded-sm">
                    ...
                    <a href="{{route('bookDetails',$book->id)}}" class=" px-0 border rounded-md text-white bg-primary p-2 w-full border-primary hover:bg-white hover:text-primary group  flex justify-center items-center }">
